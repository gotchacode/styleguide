...
<TABLE>
<TR valign="top" class="">
<TD><DIV class="toc_category">[Python Language Rules](#Python_Language_Rules)</DIV></TD>
<TD><DIV class="toc_stylepoint">
<SPAN style="padding-right: 1em; white-space:nowrap;" class="">[pychecker](#pychecker)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Imports](#Imports)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Packages](#Packages)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Exceptions](#Exceptions)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Global variables](#Global_variables)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Nested/Local/Inner Classes and Functions](#Nested/Local/Inner_Classes_and_Functions)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[List Comprehensions](#List_Comprehensions)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Default Iterators and Operators](#Default_Iterators_and_Operators)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Generators](#Generators)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Lambda Functions](#Lambda_Functions)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Conditional Expressions](#Conditional_Expressions)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Default Argument Values](#Default_Argument_Values)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Properties](#Properties)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[True/False evaluations](#True/False_evaluations)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Deprecated Language Features](#Deprecated_Language_Features)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Lexical Scoping](#Lexical_Scoping)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Function and Method Decorators](#Function_and_Method_Decorators)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Threading](#Threading)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Power Features](#Power_Features)</SPAN> </DIV></TD>
</TR>
<TR valign="top" class="">
<TD><DIV class="toc_category">[Python Style Rules](#Python_Style_Rules)</DIV></TD>
<TD><DIV class="toc_stylepoint">
<SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Semicolons](#Semicolons)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Line length](#Line_length)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Parentheses](#Parentheses)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Indentation](#Indentation)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Blank Lines](#Blank_Lines)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Whitespace](#Whitespace)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Shebang Line](#Shebang_Line)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Comments](#Comments)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Classes](#Classes)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Strings](#Strings)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Files and Sockets](#Files_and_Sockets)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[TODO Comments](#TODO_Comments)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Imports formatting](#Imports_formatting)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Statements](#Statements)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Access Control](#Access_Control)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Naming](#Naming)</SPAN> <SPAN style="padding-right: 1em; white-space:nowrap;" class="">[Main](#Main)</SPAN> </DIV></TD>
</TR>
</TABLE>
</DIV>
  <DIV class="">
...
<SPAN class="link_button" id="link-Displaying_Hidden_Details_in_this_Guide__button" name="link-Displaying_Hidden_Details_in_this_Guide__button">[
          link
        ](?showone=Displaying_Hidden_Details_in_this_Guide#Displaying_Hidden_Details_in_this_Guide)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Displaying_Hidden_Details_in_this_Guide')" name="Displaying_Hidden_Details_in_this_Guide__button" id="Displaying_Hidden_Details_in_this_Guide__button">▶</SPAN>
...
## Background
      ...
      style guide is a list of _do_s and _don't_s for Python
      programs.

      To help you format code correctly, we've created a [settings
      file for Vim](google_python_style.vim).  For Emacs, the default settings should be fine.
...
### <A name="pychecker" id="pychecker">pychecker</A>

<SPAN class="link_button" id="link-pychecker__button" name="link-pychecker__button">[
          link
        ](?showone=pychecker#pychecker)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('pychecker')" name="pychecker__button" id="pychecker__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="stylepoint_section">Cons: </SPAN>
        `pychecker` isn't perfect.  To take
...
<SPAN class="stylepoint_section">Decision:  </SPAN>
        Make sure you run `pychecker` on your code.
          ...
          For information on how to run `pychecker`, see the
          [pychecker
         homepage](http://pychecker.sourceforge.net)

          To suppress warnings, you can set a module-level variable named
          `__pychecker__` to suppress appropriate warnings.
          For example:
...
<SPAN class="link_button" id="link-Imports__button" name="link-Imports__button">[
          link
        ](?showone=Imports#Imports)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Imports')" name="Imports__button" id="Imports__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="stylepoint_section">Pros:  </SPAN>
          ...
          identifier is indicated in a consistent way; `x.Obj` says
          that object `Obj` is defined in module `x`.
...
<SPAN class="stylepoint_section">Decision:  </SPAN>
          ...
          Use `from x import y` where `x` is
          the package prefix and `y` is the module name with no
          prefix.

          Use `from x import y as z` if two modules named
          `y` are to be imported or if `y` is an
          inconveniently long name.

        For example the module
        `sound.effects.echo` may be imported as follows:
    <DIV class=""><PRE>
...
<SPAN class="link_button" id="link-Packages__button" name="link-Packages__button">[
          link
        ](?showone=Packages#Packages)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Packages')" name="Packages__button" id="Packages__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="link_button" id="link-Exceptions__button" name="link-Exceptions__button">[
          link
        ](?showone=Exceptions#Exceptions)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Exceptions')" name="Exceptions__button" id="Exceptions__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
*   Raise exceptions like this: `raise MyException('Error
            message')` or `raise MyException`.  Do not
            use the two-argument form (`raise MyException, 'Error
            message'`) or deprecated string-based exceptions
            (`raise 'Error message'`).
...
*   Never use catch-all `except:` statements, or
            ...
            is very tolerant in this regard and `except:` will
            really catch everything including misspelled names, sys.exit()
            calls, Ctrl+C interrupts, unittest failures and all kinds of
            other exceptions that you simply don't want to catch.
*   Minimize the amount of code in a
            `try`/`except` block.  The larger the
            body of the `try`, the more likely that an
            exception will be raised by a line of code that you didn't
            expect to raise an exception.  In those cases,
            the `try`/`except` block hides a real
            error.
*   Use the `finally` clause to execute code whether
            or not an exception is raised in the `try` block.
            This is often useful for cleanup, i.e., closing a file.
*   When capturing an exception, use `as` rather than
            a comma.  For example:
            <DIV class=""><PRE>
...
<SPAN class="link_button" id="link-Global_variables__button" name="link-Global_variables__button">[
          link
        ](?showone=Global_variables#Global_variables)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Global_variables')" name="Global_variables__button" id="Global_variables__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
### <A name="Nested/Local/Inner_Classes_and_Functions" id="Nested/Local/Inner_Classes_and_Functions">Nested/Local/Inner Classes and Functions</A>

<SPAN class="link_button" id="link-Nested/Local/Inner_Classes_and_Functions__button" name="link-Nested/Local/Inner_Classes_and_Functions__button">[
          link
        ](?showone=Nested/Local/Inner_Classes_and_Functions#Nested/Local/Inner_Classes_and_Functions)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Nested/Local/Inner_Classes_and_Functions')" name="Nested/Local/Inner_Classes_and_Functions__button" id="Nested/Local/Inner_Classes_and_Functions__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="stylepoint_section">Pros:  </SPAN>
      ...
      used inside of a very limited scope. Very [ADT](http://en.wikipedia.org/wiki/Abstract_data_type)-y.
...
### <A name="List_Comprehensions" id="List_Comprehensions">List Comprehensions</A>

<SPAN class="link_button" id="link-List_Comprehensions__button" name="link-List_Comprehensions__button">[
          link
        ](?showone=List_Comprehensions#List_Comprehensions)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('List_Comprehensions')" name="List_Comprehensions__button" id="List_Comprehensions__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="stylepoint_section">Decision:  </SPAN>
      ...
      mapping expression, `for` clause, filter expression.
      Multiple `for` clauses or filter expressions are not
...
### <A name="Default_Iterators_and_Operators" id="Default_Iterators_and_Operators">Default Iterators and Operators</A>

<SPAN class="link_button" id="link-Default_Iterators_and_Operators__button" name="link-Default_Iterators_and_Operators__button">[
          link
        ](?showone=Default_Iterators_and_Operators#Default_Iterators_and_Operators)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Default_Iterators_and_Operators')" name="Default_Iterators_and_Operators__button" id="Default_Iterators_and_Operators__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="link_button" id="link-Generators__button" name="link-Generators__button">[
          link
        ](?showone=Generators#Generators)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Generators')" name="Generators__button" id="Generators__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="link_button" id="link-Lambda_Functions__button" name="link-Lambda_Functions__button">[
          link
        ](?showone=Lambda_Functions#Lambda_Functions)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Lambda_Functions')" name="Lambda_Functions__button" id="Lambda_Functions__button">▶</SPAN>
      <DIV style="display:inline;" class="">
        Okay for one-liners.
      </DIV>
...
<SPAN class="stylepoint_section">Definition:  </SPAN>
      ...
      operators for higher-order functions like `map()` and
      `filter()`.
...
<SPAN class="stylepoint_section">Decision:  </SPAN>
      ...
      define it as a regular (nested) function.
       <p>
         ...
         `operator` module instead of lambda functions.  For
         example, prefer `operator.mul` to `lambda
         x, y: x * y`.
...
### <A name="Conditional_Expressions" id="Conditional_Expressions">Conditional Expressions</A>

<SPAN class="link_button" id="link-Conditional_Expressions__button" name="link-Conditional_Expressions__button">[
          link
        ](?showone=Conditional_Expressions#Conditional_Expressions)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Conditional_Expressions')" name="Conditional_Expressions__button" id="Conditional_Expressions__button">▶</SPAN>
      <DIV style="display:inline;" class="">
        Okay for one-liners.
      </DIV>
...
### <A name="Default_Argument_Values" id="Default_Argument_Values">Default Argument Values</A>

<SPAN class="link_button" id="link-Default_Argument_Values__button" name="link-Default_Argument_Values__button">[
          link
        ](?showone=Default_Argument_Values#Default_Argument_Values)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Default_Argument_Values')" name="Default_Argument_Values__button" id="Default_Argument_Values__button">▶</SPAN>
      <DIV style="display:inline;" class="">
        Okay in most cases.
      </DIV>
...
<SPAN class="stylepoint_section">Definition:  </SPAN>
      ...
      parameter list, e.g., `def foo(a, b=0):`. If
      `foo` is called with only one argument,
      `b` is set to 0. If it is called with two arguments,
      `b` has the value of the second argument.
...
<SPAN class="link_button" id="link-Properties__button" name="link-Properties__button">[
          link
        ](?showone=Properties#Properties)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Properties')" name="Properties__button" id="Properties__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="stylepoint_section">Cons: </SPAN> Properties are specified after the getter and
      ...
      properties created with the `@property` decorator - see
      below).  Must inherit from
      `object`.  Can hide side-effects much like operator
...
<SPAN class="stylepoint_section">Decision:  </SPAN> Use properties in new code to access or
      ...
      with the `@property`
      [decorator](#Function_and_Method_Decorators).
...
### <A name="True/False_evaluations" id="True/False_evaluations">True/False evaluations</A>

<SPAN class="link_button" id="link-True/False_evaluations__button" name="link-True/False_evaluations__button">[
          link
        ](?showone=True/False_evaluations#True/False_evaluations)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('True/False_evaluations')" name="True/False_evaluations__button" id="True/False_evaluations__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="stylepoint_section">Definition:  </SPAN> Python evaluates certain values as `false`
      when in a boolean context. A quick "rule of thumb" is that all
      "empty" values are considered `false` so `0, None, [], {},
...
<SPAN class="stylepoint_section">Decision:  </SPAN>
      ...
      foo:` rather than `if foo != []:`.  There are a
      few caveats that you should keep in mind though:

*   Never use `==` or `!=` to compare
        singletons like `None`.  Use `is`
        or `is not`.
*   Beware of writing `if x:` when you really mean
        `if x is not None:`—e.g., when testing whether
        a variable or argument that defaults to `None` was
...
### <A name="Deprecated_Language_Features" id="Deprecated_Language_Features">Deprecated Language Features</A>

<SPAN class="link_button" id="link-Deprecated_Language_Features__button" name="link-Deprecated_Language_Features__button">[
          link
        ](?showone=Deprecated_Language_Features#Deprecated_Language_Features)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Deprecated_Language_Features')" name="Deprecated_Language_Features__button" id="Deprecated_Language_Features__button">▶</SPAN>
      <DIV style="display:inline;" class="">
        Use string methods instead of the `string` module
        where possible.  Use function call syntax instead
        of `apply`.  Use list comprehensions
        and `for` loops instead of `filter` and
        `map` when the function argument would have been an
        inlined lambda anyway.  Use `for` loops instead of
        `reduce`.
      </DIV>
...
<SPAN class="link_button" id="link-Lexical_Scoping__button" name="link-Lexical_Scoping__button">[
          link
        ](?showone=Lexical_Scoping#Lexical_Scoping)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Lexical_Scoping')" name="Lexical_Scoping__button" id="Lexical_Scoping__button">▶</SPAN>
      <DIV style="display:inline;" class="">
        Okay to use.
      </DIV>
...
<span class="external"></span>def foo(x):
  ...
  <span class="external">  </span>bar()</PRE></DIV>
      <p>
        So `foo([1, 2, 3])` will print `1 2 3 3`, not
        `1 2 3 4`.
...
### <A name="Function_and_Method_Decorators" id="Function_and_Method_Decorators">Function and Method Decorators</A>

<SPAN class="link_button" id="link-Function_and_Method_Decorators__button" name="link-Function_and_Method_Decorators__button">[
          link
        ](?showone=Function_and_Method_Decorators#Function_and_Method_Decorators)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Function_and_Method_Decorators')" name="Function_and_Method_Decorators__button" id="Function_and_Method_Decorators__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="stylepoint_section">Definition:  </SPAN>
      ...
      [Decorators
       for Functions and Methods](http://www.python.org/doc/2.4.3/whatsnew/node6.html)
      (a.k.a "the `@` notation").
      The most common decorators are `@classmethod` and
      `@staticmethod`, for converting ordinary methods to class or
...
<SPAN class="stylepoint_section">Decision:  </SPAN> Use decorators judiciously when there is a clear
    ...
    <p>
      ...
      `pychecker` or other tools).  A decorator that is
...
<SPAN class="link_button" id="link-Threading__button" name="link-Threading__button">[
          link
        ](?showone=Threading#Threading)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Threading')" name="Threading__button" id="Threading__button">▶</SPAN>
      <DIV style="display:inline;" class="">
      ...
      <DIV class=""><DIV class="stylepoint_body" name="Threading__body" id="Threading__body" style="display: none">
          ...
          aren't atomic (e.g. if `__hash__` or
          `__eq__` are implemented as Python methods) and their
          atomicity should not be relied upon.  Neither should you rely on
          atomic variable assignment (since this in turn depends on
          dictionaries).

          Use the Queue module's `Queue` data type as the preferred
          way to
          ...
          `threading.Condition` instead of using lower-level
          locks.
...
<SPAN class="link_button" id="link-Power_Features__button" name="link-Power_Features__button">[
          link
        ](?showone=Power_Features#Power_Features)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Power_Features')" name="Power_Features__button" id="Power_Features__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="link_button" id="link-Semicolons__button" name="link-Semicolons__button">[
          link
        ](?showone=Semicolons#Semicolons)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Semicolons')" name="Semicolons__button" id="Semicolons__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="link_button" id="link-Line_length__button" name="link-Line_length__button">[
          link
        ](?showone=Line_length#Line_length)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Line_length')" name="Line_length__button" id="Line_length__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
*   URLs in comments.
      ...
      [implicit
      line joining inside parentheses, brackets and braces](http://docs.python.org/reference/lexical_analysis.html#implicit-line-joining).
...
<SPAN class="link_button" id="link-Parentheses__button" name="link-Parentheses__button">[
          link
        ](?showone=Parentheses#Parentheses)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Parentheses')" name="Parentheses__button" id="Parentheses__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="link_button" id="link-Indentation__button" name="link-Indentation__button">[
          link
        ](?showone=Indentation#Indentation)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Indentation')" name="Indentation__button" id="Indentation__button">▶</SPAN>
      <DIV style="display:inline;" class="">
      ...
      [line length](#Line_length) section; or using a hanging
...
<SPAN class="link_button" id="link-Blank_Lines__button" name="link-Blank_Lines__button">[
          link
        ](?showone=Blank_Lines#Blank_Lines)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Blank_Lines')" name="Blank_Lines__button" id="Blank_Lines__button">▶</SPAN>
      <DIV style="display:inline;" class="">
      ...
      and between the `class` line and the first method.
...
<SPAN class="link_button" id="link-Whitespace__button" name="link-Whitespace__button">[
          link
        ](?showone=Whitespace#Whitespace)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Whitespace')" name="Whitespace__button" id="Whitespace__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<DIV class=""><PRE class="badcode">No:  <span class="external"></span>dict ['key'] = list [index]</PRE></DIV>
      ...
      (`and, or, not`).  Use your better judgment for the
...
<SPAN class="link_button" id="link-Shebang_Line__button" name="link-Shebang_Line__button">[
          link
        ](?showone=Shebang_Line#Shebang_Line)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Shebang_Line')" name="Shebang_Line__button" id="Shebang_Line__button">▶</SPAN>
      <DIV style="display:inline;" class="">
        Most `.py` files do not need to start with a
...
<SPAN class="link_button" id="link-Comments__button" name="link-Comments__button">[
          link
        ](?showone=Comments#Comments)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Comments')" name="Comments__button" id="Comments__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="stylepoint_subsection">Doc Strings</SPAN>
    ...
    <p>
      ...
      automatically through the `__doc__` member of the
      object and are used by `pydoc`.  (Try running
      `pydoc` on your module to see how it looks.)  Our
...
<SPAN class="link_button" id="link-Classes__button" name="link-Classes__button">[
          link
        ](?showone=Classes#Classes)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Classes')" name="Classes__button" id="Classes__button">▶</SPAN>
      <DIV style="display:inline;" class="">
        If a class inherits from no other base classes, explicitly inherit
    from `object`.  This also applies to nested classes.
      </DIV>
...
Inheriting from `object` is needed to make properties work
...
<SPAN class="link_button" id="link-Strings__button" name="link-Strings__button">[
          link
        ](?showone=Strings#Strings)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Strings')" name="Strings__button" id="Strings__button">▶</SPAN>
      <DIV style="display:inline;" class="">
        Use the `%` operator for formatting strings,
        even when the parameters are all strings.  Use your best judgement
        to decide between `+` and `%` though.
      </DIV>
...
<DIV class=""><PRE class="badcode">No: <span class="external"></span>x = '%s%s' % (a, b)  # use + in this case
    ...
    <span class="external"></span>x = 'name: ' + name + '; score: ' + str(n)</PRE></DIV>
      ...
      Avoid using the `+` and `+=` operators to
      ...
      `''.join` the list after the loop terminates (or, write each
      substring to a `cStringIO.StringIO` buffer).
...
<DIV class=""><PRE class="badcode">No: <span class="external"></span>employee_table = '&lt;table&gt;'
    ...
    <span class="external"></span>employee_table += '&lt;/table&gt;'</PRE></DIV>
      ...
      `'''`.  Note, however, that it is often cleaner to
...
### <A name="Files_and_Sockets" id="Files_and_Sockets">Files and Sockets</A>

<SPAN class="link_button" id="link-Files_and_Sockets__button" name="link-Files_and_Sockets__button">[
          link
        ](?showone=Files_and_Sockets#Files_and_Sockets)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Files_and_Sockets')" name="Files_and_Sockets__button" id="Files_and_Sockets__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="link_button" id="link-TODO_Comments__button" name="link-TODO_Comments__button">[
          link
        ](?showone=TODO_Comments#TODO_Comments)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('TODO_Comments')" name="TODO_Comments__button" id="TODO_Comments__button">▶</SPAN>
      <DIV style="display:inline;" class="">
      ...
      <DIV class=""><DIV class="stylepoint_body" name="TODO_Comments__body" id="TODO_Comments__body" style="display: none">
          ...
          `TODO`s should include the string `TODO` in
          ...
          a consistent `TODO` format that can be searched to find the
          person who can provide more details upon request.  A
          `TODO` is not a commitment that the person referenced
...
### <A name="Imports_formatting" id="Imports_formatting">Imports formatting</A>

<SPAN class="link_button" id="link-Imports_formatting__button" name="link-Imports_formatting__button">[
          link
        ](?showone=Imports_formatting#Imports_formatting)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Imports_formatting')" name="Imports_formatting__button" id="Imports_formatting__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
<SPAN class="link_button" id="link-Statements__button" name="link-Statements__button">[
          link
        ](?showone=Statements#Statements)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Statements')" name="Statements__button" id="Statements__button">▶</SPAN>
      <DIV style="display:inline;" class="">
      ...
      with `try`/`except` since the
      `try` and `except` can't both fit on the
      same line, and you can only do so with an `if` if
      there is no `else`.
...
<SPAN class="link_button" id="link-Access_Control__button" name="link-Access_Control__button">[
          link
        ](?showone=Access_Control#Access_Control)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Access_Control')" name="Access_Control__button" id="Access_Control__button">▶</SPAN>
      <DIV style="display:inline;" class="">
      ...
      [Naming](#naming) guidelines) such as `get_foo()`
      and `set_foo()`. If the past behavior allowed access through a
...
<SPAN class="link_button" id="link-Naming__button" name="link-Naming__button">[
          link
        ](?showone=Naming#Naming)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Naming')" name="Naming__button" id="Naming__button">▶</SPAN>
      <DIV style="display:inline;" class="">
...
*   "Internal" means internal to a module or protected
        or private within a class.
*   Prepending a single underscore (`_`) has some
        support for protecting module variables and functions (not included
        with `import * from`).  Prepending a double underscore
        (`__`) to an instance variable or method
...
*   Use CapWords for class names, but lower_with_under.py for module names.
        ...
        `import StringIO` or `from StringIO import
        StringIO`?")
...
<SPAN class="link_button" id="link-Main__button" name="link-Main__button">[
          link
        ](?showone=Main#Main)</SPAN><SPAN class="showhide_button" onclick="javascript:ShowHideByName('Main')" name="Main__button" id="Main__button">▶</SPAN>
      <DIV style="display:inline;" class="">
      ...
      In Python,
      `pychecker`, `pydoc`, and unit tests
      require modules to be importable.  Your code should always check
      `if __name__ == '__main__'` before executing your
...
<span class="external"></span>
      ...
      file is being `pycheck`ed or `pydoc`ed.
